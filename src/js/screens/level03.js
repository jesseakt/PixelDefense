game.Level03PlayScreen = me.ScreenObject.extend({
    onResetEvent: function() {
        ...
        game.levelData.waveInfo =   [[3, 150,   4,  250,      0, 0],
                                    [4,  100,   2,  150,    0, 0],
                                    [4,  100,   3,  150,    0, 0],
                                    [10, 100,   0,  0,      0, 0],
                                    [5,  100,   5,  150,    0, 0],
        ...
        //Power of Footmen, Goblins, and Imps, respectively
        ...
        //Load the map
        me.levelDirector.loadLevel("map03");
